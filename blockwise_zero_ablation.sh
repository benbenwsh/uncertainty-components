...
python3 ./blockwise_zero_ablation/run_blockwise_zero_ablation.py --input_h5 ./process_generations/processed_generations_more_h5/3_200_subblocks_one_more_prob_tok/train_verbalised_embeddings.h5 --no-enable_brief --num_samples 1000 --device cuda:0 --ablate_subblocks attn mlp --ablate_layers 10-16 --ablate_low_confidence_samples