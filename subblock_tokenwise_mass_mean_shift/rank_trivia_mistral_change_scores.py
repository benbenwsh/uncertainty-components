#!/usr/bin/env python3
"""Rank trivia-Mistral subblock change scores for tokens 0, 1, and 6.
...
MISTRAL_RESULTS = SCRIPT_DIR / "results" / "individual_layers" / "mistral"
OUTPUT_DIR = MISTRAL_RESULTS / "change_score_analysis"
...
RUN_PAIRS = (
    {
        "name": "both",
        "low_to_high": "8_trivia_mistral_both_low_to_high",
        "high_to_low": "10_trivia_mistral_both_high_to_low",
        "average": True,
        "label": lambda layer: f"a{layer}m{layer}",
    },
    {
        "name": "attn",
        "low_to_high": "12_trivia_mistral_attn_low_to_high",
        "high_to_low": "11_trivia_mistral_attn_high_to_low",
        "average": False,
        "label": lambda layer: f"a{layer}",
    },
    {
        "name": "mlp",
        "low_to_high": "9_trivia_mistral_mlp_low_to_high",
        "high_to_low": "13_trivia_mistral_mlp_high_to_low",
        "average": False,
...
def _load_summary(run_dir_name: str) -> dict:
    path = MISTRAL_RESULTS / run_dir_name / "summary.json"
