...
from uncertainty.models.huggingface_models_all_embeddings import HuggingfaceModelAllEmbeddings
...
def init_model(args):
    ...
    if 'llama' in mn.lower() or 'falcon' in mn.lower() or 'mistral' in mn.lower() or 'phi' in mn.lower():
        # If confidence flag is set, use the all-embeddings model implementation.
        if args.confidence == True:
            print('Initialising HuggingfaceModelAllEmbeddings for confidence embeddings...')
            model = HuggingfaceModelAllEmbeddings(
                mn, stop_sequences='default',
                max_new_tokens=args.model_max_new_tokens)
        else:
            print('Initialising HuggingfaceModel...')
