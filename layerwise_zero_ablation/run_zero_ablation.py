...
def write_config_txt(
    ...
    *,
    ...
    lines = [
        ...
        "",
        "[Data]",
        "dataset=TimoImhof/TriviaQA-in-SQuAD-format (unmodified)",
...
def _absolute_prob_positions(
    ...
    """Convert the ``PROBABILITY_MARKER`` substring span into absolute sequence positions by adding the prompt length."""
