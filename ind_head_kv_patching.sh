...
python3 ./ind_head_kv_patching/run_ind_head_kv_patching.py \
  ...
  --device cuda:0 \
  --ablate_layers 10-16 \
  --patch_components q,k,v \
  --no-mean_from_low_confidence
  # --ablate_heads_by_layer 3.1,7.2,8.0,8.5,9.3,10.2,11.2,11.5,12.3,12.5,12.6,13.2,13.6,14.0,14.2,14.5,14.6,15.1,15.3,15.4,16.0,16.1,16.2,16.6,16.7,17.0,17.1,17.3,18.3,18.4,19.0,19.2,19.6,19.7,20.5,25.3,25.5,25.6,26.5,26.7 \
